...
RSpec.feature "ParticipationRemovals", type: :feature do
  Steps 'Signing up' do
    Given 'An Activty' do
    ...
    Given "The participation count" do
    ...
    Then 'I should have a new participation and that participation is for the correct activity' do
      expect(Participation.count).to eq(@participation_count + 1)
    end
    ...
    Then "I want to delete my participation in an activity, by clicking the active link" do
      click_link_or_button 'Active'
    end
    And 'I should see a flash message telling me I have been successfully removed' do
      expect(page).to have_content("You have successfully been removed from this activity.")
    end
    And 'I should see the word "Sign Up" instead of "Active"' do
      expect(page).to have_content("Sign Up")
