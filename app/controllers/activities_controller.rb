class ActivitiesController < ApplicationController
  ...
  private
    ...
    def activity_params
      params.require(:activity).permit(:name, :user_id, :website, :description, :next_at, :location_id, :schedule, :requirement, :pricing, :fitness_level, :terms_of_service, location_attributes: [:id, :_destroy, :name, :address, :city, :state, :zip])
    end
end
